var MSG = {
  ...
  firstModalLabel: "Bienvenue sur Skyrover.ai !",
  ...
  varText5:"'!",
  paypalModalLabel:"Aider le logiciel libre !",
  paypalBody:"Merci de faire un don pour aider au développement et à l'amélioration de ce logiciel, SANS VOUS LE LOGICIEL LIBRE NE PEUT SUBSISTER !",
  msg_ajax_ko:"Requêtes AJAX non supportées par votre navigateur, les fonctionnalités\n"
	+ "suivantes ne seront pas opérationnelles : \n"
	+ "- chargement de blocs via l'URL \n"
	+ "- supervision\n"
